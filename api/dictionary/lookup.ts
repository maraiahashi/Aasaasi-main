export default async function handler(req: any, res: any) {
  try {
    ...
    res.status(200).json({ [fieldIn]: (doc as any)[fieldIn], [fieldOut]: (doc as any)[fieldOut],
                           pos: (doc as any).pos || null, pronunciation: (doc as any).pronunciation || null,
                           source: (doc as any).source || null, updatedAt: (doc as any).updatedAt || null });
  } catch (e: any) {
